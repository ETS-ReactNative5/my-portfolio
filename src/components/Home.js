...
class Home extends Component{
    ...
    return (
        <main style={{backgroundImage: "url(" + dtbg + ")"}} className="min-w-screen bg-cover">
            ...
            <div className="hover:bg-gray-500 mx-4 rounded bg-red-400 shadow-2xl bg-opacity-100 lg:rounded-full">
                <h1 className="pt-3 text-center text-4xl lg:text-6xl text-green-100 font-bold cursive lg:home-name">Hello. I'm <span className="text-purple-600">Michael</span></h1>
