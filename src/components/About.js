  ...
  return (
    <main style={{backgroundImage: "url(" + Background + ")"}} className="bg-cover relative">
      <div className="lg:pt-48 p-3 lg:px-20 px-3 mx-auto relative">
        <section className="bg-black bg-opacity-50 rounded-lg shadow-2xl lg:flex lg:p-20 py-6 px-3">
          <img
          ...
          <div className="rounded text-lg bg-red-200 bg-opacity-75 mt-3">
            <h1 className="p-2 text-center cursive text-3xl lg:text-5xl text-gray-100 mb-4">
              Hey there. I'm{" "}
